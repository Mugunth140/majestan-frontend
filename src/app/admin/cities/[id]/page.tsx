  ...
  return (
    <div className="!p-6 !w-full !space-y-6">
      <div className="!flex !items-center !gap-4">
        ...
        <div>
          <h1 className="!text-[22px] !font-semibold !text-gray-800 dark:!text-white !tracking-tight">Edit City</h1>
          <p className="!text-[14px] !text-gray-500 dark:!text-gray-400 !mt-1">Update city details.</p>
        </div>
      </div>
