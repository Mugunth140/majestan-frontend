      ...
      <div className="!grid !grid-cols-1 md:!grid-cols-2 !gap-6">
        ...
        <div className="!space-y-2">
          ...
          <div className="!relative">
            <select 
              ...
              disabled={!cityId}
              className="!w-full !appearance-none !bg-white/30 !backdrop-blur-md !border !border-white/50 !text-gray-800 !font-medium !rounded-xl !pl-4 !pr-10 !py-3 !text-[14px] focus:!ring-4 focus:!ring-blue-500/20 focus:!border-white/80 !outline-none !transition-all !cursor-pointer !block !shadow-inner disabled:!opacity-50 disabled:!cursor-not-allowed"
            >
        ...
        <div className="!space-y-2">
          ...
          <input 
            ...
            {...register('state')} 
            readOnly
            className="!w-full !bg-white/10 !backdrop-blur-sm !border !border-white/30 !rounded-xl !px-4 !py-3 !text-[14px] !font-medium !text-gray-500 !shadow-inner !outline-none !cursor-not-allowed" 
          />
        </div>
