  ...
  return (
    <div className="!p-6 !w-full !space-y-6">
      <div className="!flex !items-center !gap-4">
        <Link href="/admin/cities" className="!p-2 hover:!bg-gray-100 dark:hover:!bg-[#262730] dark:!bg-[#262730] !rounded-xl !transition-colors">
          <ArrowLeft size={20} />
        </Link>
        <div>
          <h1 className="!text-[22px] !font-semibold !text-gray-800 dark:!text-white !tracking-tight">Add City</h1>
          <p className="!text-[14px] !text-gray-500 dark:!text-gray-400 !mt-1">Create a new city for property listings.</p>
        </div>
      </div>
        ...
        <div className="!p-6 !space-y-6">
          ...
          <div className="!grid !grid-cols-1 md:!grid-cols-2 !gap-6">
            <div className="!space-y-2">
              <label className="!text-[14px] !font-medium !text-gray-800 dark:!text-white">City Name <span className="!text-red-500">*</span></label>
              <input
                type="text"
                required
            ...
            <div className="!space-y-2">
              <label className="!text-[14px] !font-medium !text-gray-800 dark:!text-white">State Name <span className="!text-red-500">*</span></label>
              <select
                required
            ...
            <div className="!space-y-2">
              <label className="!text-[14px] !font-medium !text-gray-800 dark:!text-white">Country</label>
              <input
                type="text"
                readOnly
                value={formData.country_name}
                className="!w-full !px-4 !py-2.5 !bg-gray-50 dark:!bg-[#1c1d27]/50 !border !border-gray-100 dark:!border-[#262730] !shadow-sm !rounded-xl !text-[14px] !text-gray-500 dark:!text-gray-400"
              />
            </div>
