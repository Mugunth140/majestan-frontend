...
<!--<script>-->
<!--    var wgPropertyAccordion = function () {-->

<!--    function checkScreenSize() {-->
<!--        if (window.matchMedia("(max-width: 767px)").matches) {-->
<!--            $(".wg-collapse-content").css("display", "none");-->
<!--            $(".wg-property").removeClass("open");-->
<!--        } else {-->
<!--            $(".wg-collapse-content").css("display", "block");-->
<!--            $(".wg-property").removeClass("open");-->
<!--        }-->
<!--    }-->
...
<!--    $(".wg-title-mobile").on("click", function () {-->

<!--        if (!window.matchMedia("(max-width: 767px)").matches) return;-->

<!--        var parent = $(this).closest(".wg-property");-->
<!--        var content = $(this).next(".wg-collapse-content");-->
...
<script>
  ...
  $('#expertcontact').validate({
        ...
        messages: {
            ...
            mobileno: { required: "Please enter your mobile number.", digits: "Only numbers allowed.", minlength: "Must be 10 digits.", maxlength: "Must be 10 digits." },
        ...
        submitHandler: function (form, event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response === 'Yes') {
                        Swal.fire({ icon: "success", title: "Success", text: "Enquiry sent successfully!", confirmButtonColor: "#28a745" }).
                        then(() => {
...
//         var parts = pageUrl.split("/"); // Split URL by "/"
//         var encodedId = parts.pop(); // Get last part (encoded ID)

//         try {
//             var decodedId = atob(encodedId); // Decode Base64 ID
//             var newUrl = parts.join("/") + "/" + decodedId; // Reconstruct URL
//             var whatsappUrl = "https://wa.me/?text=" + encodeURIComponent(newUrl);

//             window.open(whatsappUrl, "_blank"); // Open WhatsApp share link
//         } catch (e) {
//             alert("Invalid URL format for sharing.");
//         }
//     }
...
export function ApartmentDetailsView(): React.JSX.Element {
