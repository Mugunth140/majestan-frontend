...
export default function EditLocalityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(e);
      alert("Failed to update locality. Please try again.");
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="w-full! max-w-4xl! mx-auto! space-y-6!">
      <div className="flex! items-center! justify-between! gap-4!">
        <div className="flex! items-center! gap-4!">
          ...
          <div>
            <h2 className="text-2xl! font-bold! text-gray-900! tracking-tight!">Edit City / Area</h2>
            <p className="text-sm! text-gray-500! mt-1!">Update city or sublocation details</p>
          </div>
        </div>
      </div>
