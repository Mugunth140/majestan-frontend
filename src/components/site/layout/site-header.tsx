...
const headerMarkup = `<!-- wrapper -->
    <div id="wrapper" class="counter-scroll">



        <!-- .header -->
        <header id="header-main" class="header style-4 header-fixed">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="header-inner-wrap">
                                ...
                                <nav class="main-menu">
                                    <ul class="navigation ">
                                        <li class="current"><a href="#">Buy <i class="icon-CaretDown"></i></a>
                                            <ul class="submenu">
                                                <!--<li><a href="/Apartment/apartment">Apartment</a></li>-->
                                                <!--<li><a href="/Villa/villa">Villa</a></li>-->
                                                <!--<li><a href="/Independent_houses/independent_house">Independent House</a></li>-->
                                                <!--<li><a href="/Plots/plot">Plot</a></li>-->
                                                <!--<li><a href="/Farmland/farmland">Farmland</a></li>-->
                                                <!--<li><a href="/Commercial_space/commercial">Commercial</a></li>-->
                                                <!--<li><a href="/Industrial/industrial">Industrial</a></li>-->
                                                
                                                
                                                 

                                                <li><a href="/buy-apartments-coimbatore">Apartments</a></li>
                                                <li><a href="/buy-villas-coimbatore">Villas</a></li>
                                                <li><a href="/buy-independent-houses-coimbatore">Independent Houses</a></li>
                                                <li><a href="/buy-plots-coimbatore">Plots</a></li>
                                                <li><a href="/buy-farmlands-coimbatore">Farmlands</a></li>
                                                <li><a href="/buy-commercial-space-coimbatore">Commercial Spaces</a></li>
                                                <li><a href="/buy-industrials-coimbatore">Industrials</a></li>

                                            </ul>
                                        </li>
                                        <li class="current"><a href="#">Rent <i class="icon-CaretDown"></i></a>
                                            <ul class="submenu">
                                                <!-- <li><a href="/Commercial_space/commercial_rent">Commercial</a></li>-->
                                                <!--<li><a href="/Industrial/industrial_rent">Industrial</a></li>-->
                                                <!--<li><a href="/Apartment/apartment_rent">Apartment</a></li>-->
                                                <!--<li><a href="/Villa/villa_rent">Villa</a></li>-->
                                                <!--<li><a href="/Independent_houses/independent_house_Rent">Independent House</a></li>-->
                                                
                                                
                                                <li><a href="/rent-commercial-space-coimbatore">Commercial</a></li>
                                                <li><a href="/rent-industrials-coimbatore">Industrial</a></li>
                                                <li><a href="/rent-apartments-coimbatore">Apartment</a></li>
                                                <li><a href="/rent-villas-coimbatore">Villa</a></li>
                                                <li><a href="/rent-independent-houses-coimbatore">Independent House</a></li>
                                                <li><a href="/rent-co-working-coimbatore">Co-Working</a></li>
                                                
                                               
                                            </ul>
                                        </li>
                                        <li class="current"><a href="#">Services <i class="icon-CaretDown"></i></a>
                                            <ul class="submenu">
                                                <!--<li><a href="/Services/property_management">Property-->
                                                <!--        Management</a></li>-->
                                                <!--<li><a href="/Services/liaisoning">Liaisoning-->
                                                <!--        Service</a></li>-->
                                                <!--<li><a-->
                                                <!--        href="/Services/professional_brokerage_services">Brokerage-->
                                                <!--        Service</a></li>-->
                                                <!--<li><a href="/Services/financial_assistance">Financial-->
                                                <!--        Assistance</a></li>-->
                                                <!--<li><a href="/Services/nri">NRI</a></li>-->
                                                
                                                
                                                <li><a href="/services/property-management">Property
                                                        Management</a></li>
                                                <li><a href="/services/liaisoning">Liaisoning
                                                        Service</a></li>
                                                <li><a
                                                        href="/services/professional-brokerage-services">Brokerage
                                                        Service</a></li>
                                                <li><a href="/services/financial-assistance">Financial
                                                        Assistance</a></li>
                                                <li><a href="/services/nri-property-investment">NRI</a></li>
                                            </ul>
                                        </li>
                                ...
                                <div class="header-right">
                                    ...
                                    <a href="/wishlist">
                                        <div class="wishlist-page">
                                            <span class="heart-container">
                                                <i class="fa-solid fa-heart solid-heart-1"
                                                    style="font-size: 25px; color: #27427fb8;"></i>
                                                <i class="fa-solid fa-heart solid-heart-2"
                                                    style="font-size: 25px; color:#27427F;"></i>
                                            </span>
                                            <p class="wishlist-count-border">
                                                <span class="pro-count blue wishlist-item-showing"
                                                    style="font-size: 12px;color: #27427F;"></span>
                                            </p>
                                    ...
                                    <!--<div class="btn-add">-->
                                    <!--    <a style="font-size: 15px !important;" class="tf-btn style-border pd-23"-->
                                    <!--        href="/Home/rent_sell">Rent / Sell Your Property</a>-->
                                    <!--</div>-->
                                    
                                     <div class="btn-add">
                                        <a style="font-size: 15px !important;" class="tf-btn style-border pd-23"
                                            href="/rent-or-sell-your-property">Rent / Sell Your Property</a>
                                    </div>
        ...
        <style>
            ...
            .wishlist:hover .regular-heart {
                display: none;
            }

            .wishlist:hover .solid-heart {
                display: inline;
                transform: scale(1.2);
            ...
            .heart-container .solid-heart-1,
            .heart-container .solid-heart-2 {
                position: absolute;
                top: 0;
                left: 0;
                transition: transform 0.3s ease, opacity 0.3s ease;
            ...
            .heart-container:hover .solid-heart-1 {
                display: none !important;
            }

            .heart-container:hover .solid-heart-2 {
            ...
            .wishlist.active .regular-heart {
                display: none;
            }

            .wishlist.active .solid-heart {
                display: inline;
            }
