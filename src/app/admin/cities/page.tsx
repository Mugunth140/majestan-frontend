  ...
  return (
    <div className="!px-3 !w-full !space-y-3">
      ...
      <div className="!flex !flex-col sm:!flex-row sm:!items-center !justify-between !gap-4">
        <div>
          <h1 className="!text-2xl !font-medium !text-gray-800 dark:!text-white !tracking-tight !ml-3">Cities</h1>
        </div>
        <Link 
          ...
          <table className="!w-full !text-left !border-collapse">
            <thead>
              <tr className="!bg-[#fbfbfc] dark:!bg-[#0f1015] !border-b !border-gray-100 dark:!border-[#262730]">
                <th className="!px-6 !py-4 !text-[12px] !font-semibold !text-gray-500 dark:!text-gray-400 !uppercase !tracking-wider">City</th>
                <th className="!px-6 !py-4 !text-[12px] !font-semibold !text-gray-500 dark:!text-gray-400 !uppercase !tracking-wider">State / Country</th>
            ...
            <tbody className="!divide-y !divide-gray-100">
              {loading ? (
                ...
                cities.map((city) => (
                  <tr key={city.id} className="!bg-white dark:!bg-[#171821] hover:!bg-[#fbfbfc] dark:!bg-[#0f1015] !transition-colors !group">
                    <td className="!px-6 !py-4">
                      <div className="!flex !items-center !gap-3">
                        <div className="!w-10 !h-10 !rounded-lg !bg-gray-100 dark:!bg-[#262730] !flex !items-center !justify-center !text-gray-400 !shrink-0">
                          <MapPin size={20} />
                        </div>
                        <div>
                          <div className="!font-medium !text-gray-800 dark:!text-white group-hover:!text-blue-600 !transition-colors !capitalize">{city.city_name}</div>
                        </div>
                      </div>
                    </td>
                    <td className="!px-6 !py-4">
                      <div className="!text-gray-800 dark:!text-white !capitalize">{city.state_name || 'N/A'}</div>
