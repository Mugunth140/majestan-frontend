...
export const specificationsSchema = z.object({
  ...
  propertyFacing: z.enum(['East', 'West', 'North', 'South', 'North East', 'North West', 'South East', 'South West']).or(z.literal('')).optional(),
  propertyAge: z.enum(['New', '1-3 Years', '3-5 Years', '5-10 Years', '10+ Years']).or(z.literal('')).optional(),
  furnishing: z.enum(['Furnished', 'Semi Furnished', 'Unfurnished']).or(z.literal('')).optional(),
