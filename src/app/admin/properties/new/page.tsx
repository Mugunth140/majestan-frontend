          ...
          <div className="grid! grid-cols-1! md:grid-cols-2! gap-6!">
            ...
            <div className="space-y-2!">
              ...
              <div className="relative!">
                <select name="propertyType" value={formData.propertyType} onChange={handleChange} className="w-full! appearance-none! bg-gray-50! border! border-gray-200! text-gray-800! rounded-xl! pl-4! pr-10! py-3! text-[14px]! focus:ring-1! focus:ring-gray-900/50! outline-none! transition-all! cursor-pointer! block!" style={{ display: 'block', width: '100%', minHeight: '45px', border: '1px solid #e5e7eb', backgroundColor: '#f9fafb', color: '#111827', borderRadius: '0.75rem', padding: '0.625rem 1rem', opacity: 1, position: 'relative', zIndex: 0, appearance: 'none' }}>
            ...
            <div className="space-y-2!">
              ...
              <div className="relative!">
                <select name="status" value={formData.status} onChange={handleChange} className="w-full! appearance-none! bg-gray-50! border! border-gray-200! text-gray-800! rounded-xl! pl-4! pr-10! py-3! text-[14px]! focus:ring-1! focus:ring-gray-900/50! outline-none! transition-all! cursor-pointer! block!" style={{ display: 'block', width: '100%', minHeight: '45px', border: '1px solid #e5e7eb', backgroundColor: '#f9fafb', color: '#111827', borderRadius: '0.75rem', padding: '0.625rem 1rem', opacity: 1, position: 'relative', zIndex: 0, appearance: 'none' }}>
            ...
            <div className="space-y-2!">
              ...
              <div className="relative!">
                <select required name="cityId" value={formData.cityId} onChange={handleChange} className="w-full! appearance-none! bg-gray-50! border! border-gray-200! text-gray-800! rounded-xl! pl-4! pr-10! py-3! text-[14px]! focus:ring-1! focus:ring-gray-900/50! outline-none! transition-all! cursor-pointer! block!" style={{ display: 'block', width: '100%', minHeight: '45px', border: '1px solid #e5e7eb', backgroundColor: '#f9fafb', color: '#111827', borderRadius: '0.75rem', padding: '0.625rem 1rem', opacity: 1, position: 'relative', zIndex: 0, appearance: 'none' }}>
