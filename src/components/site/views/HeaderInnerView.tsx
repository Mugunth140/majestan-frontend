...
const html = `<!-- wrapper -->
    <div id="wrapper" class="counter-scroll">
                        ...
                        <div class="top-bar-inner">
                            <ul class="top-bar-info">
                                <li>
                                    ...
                                    <p>Phone: <span class="fw-7">(603) 555-0123</span></p>
                                </li>
                                <li>
                                    <i class="icon-mail"></i>
                                    <p>Email: <a href="#">themesflat@gmail.com</a></p>
                                </li>
                            </ul>
        ...
        <!-- .header -->
        <header id="header-main" class="header style-4 header-fixed header-inner">
                        ...
                        <div class="col-12">
                            <div class="header-inner-wrap">
                                    ...
                                    <ul class="navigation ">
                                        <li class="current-menu"><a href="#">Buy</a>
                                            <!-- <ul class="submenu">
                                                ...
                                                <li class="current-item"><a href="home04.html">Home Page 04</a></li>
                                ...
                                <div class="header-right">
                                    ...
                                    <div class="btn-add">
                                        <a class="tf-btn style-border pd-23" href="#">Seller’s Spot</a>
                                    </div>
...
export function HeaderInnerView(): React.JSX.Element {
