...
.footer-banner-slider #footerBannerCarousel .carousel-item {
    height: auto !important;
}

.footer-banner-slider #footerBannerCarousel .footer-banner-slide {
    height: auto !important;
    background: none !important;
    line-height: 0;
}

.footer-banner-slider #footerBannerCarousel .footer-banner-slide img {
    display: block;
    width: 100%;
    height: auto;
    object-fit: contain;
...
success: function (response) {
    ...
    console.log(response); // now object
...
export function ApartmentView(): React.JSX.Element {
